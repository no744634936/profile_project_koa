...
import {addExperience} from "../../redux/profile/profileAction.js"
    ...
    return (
        <div style={{marginTop:"100px"}}>
            ...
            <form className="form" onSubmit={e=>sumbitValues(e)}>
                ...
                <input type="text" placeholder="* Job Title" name="title" value={title} onChange={e=>changeValue(e)} required />
                </div>
                <div className="form-group">
                <input type="text" placeholder="* Company" name="company" value={company} onChange={e=>changeValue(e)} required />
                </div>
                <div className="form-group">
