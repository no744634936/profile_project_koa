...
module.exports={
    ...
    create_post_failed:{errnum:10015 ,message:"无法添加post"},
    no_auth_error:{errnum:10016 ,message:"not auhorized,没有权限删除，不是本人"},
    already_liked:{errnum:10017 ,message:"已经赞过了"},
    not_liked:{errnum:10018 ,message:"还没点赞"},
    comment_not_exist:{errnum:10019 ,message:"该评论不存在"},
}
